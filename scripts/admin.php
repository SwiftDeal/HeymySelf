...
Min_DB;$Bb=$b->credentials();if($h->connect($Bb[0],$Bb[1],$Bb[2])){if($h->server_info>=9)$h->query("SET application_name = 'Heymyself'");return$h;}return$h->error;}function
get_databases(){return
...
name(){return"<a href='http://www.heymyself.com/' target='_blank' id='h1'>Heymyself</a>";}function
credentials(){return
