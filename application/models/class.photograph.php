<?php
require_once $libpath = substr(str_replace('\\', '/', __dir__), 0, -18).'library/parameters.php';
...
class Photograph extends DatabaseObject {
	...
	public function image_path_thumb() {
		global $baseUrl;
		if((!empty($this->size))&&($this->size < 1363150)) $userImage = $baseUrl."assets/uploads/".$this->upload_dir."/sml_".$this->filename;
